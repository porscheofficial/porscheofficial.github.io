...
<ImageText imageSrc="/assets/blog/aosp/1.jpg" imageAlt="Macan, 2024, Porsche AG" theme="light" left
    ...
    I am a solution architect with a solid background in software engineering. Since
    more than one year, I am part of the Infotainment & Connect (CIU) team that
    leads the Android development at Porsche. I am passionate about breaking new
    ground, building vibrant, user-centric features, and increasing the overall
    driver experience. 
</ImageText>
...
<ImageText imageSrc="/assets/blog/aosp/2.jpg" imageAlt="Macan, 2024, Porsche AG" theme="light"
    ...
    Porsche is integrating Android with the help of our Tier 2 and Tier 1 suppliers
    into the new HCP3 control unit. By building upon a well-proven and established
    open platform, we have significantly reduced the pain of having to integrate
    proprietary solutions being sold as a black box to Porsche. The freedom to
    analyze and modify the source code allows us to confirm issues and request
    changes that meet our requirements at Porsche. It is also worth noting, that the
    prospering ecosystem around the Android open-source project offers us the
