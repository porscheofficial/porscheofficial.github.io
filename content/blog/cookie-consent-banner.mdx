...
<ImageText imageSrc="/assets/blog/ccb/1.png" imageAlt="Porsche Digital Campus" theme="light" left
    title="You are currently maintaining Porsche's open-source project Cookie Consent Banner on GitHub. How would you explain your project to a five-year-old? What problem does your project solve for Porsche?">
    ...
    **Patrick:** I'm sure everybody remembers the time when cookie banners hit the
    ...
    the maintainers to implement such a solution. But it makes sense, informing the
    user's what is going on with their data. So we created a component that is not
    ...
    the visitor. The developers should have total control over what's going on the
...
<ImageText imageSrc="/assets/blog/ccb/2.jpg" imageAlt="Porsche Digital Campus" theme="light"
